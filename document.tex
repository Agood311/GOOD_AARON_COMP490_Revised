...
\pdfinfo{
    /Title (Hybrid Retrieval and Domain-Aware Filtering for Federal Procurement on SAM.gov)
    /Author (Aaron Good)
}

% set the title and author information
\title{Hybrid Retrieval and Domain-Aware Filtering for Federal Procurement on SAM.gov}
\author{Aaron Good}
